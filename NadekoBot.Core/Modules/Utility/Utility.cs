        ...
        public async Task Stats()
        {
            ...
            await ctx.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"Rin v{StatsService.BotVersion}")
                                          .WithIconUrl("https://cdn.discordapp.com/avatars/449682643370377241/16d259fe93aefbb321159ab8ac2df858.png?size=128"))
